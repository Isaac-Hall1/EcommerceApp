        ...
        <div className="basis-2/12 flex items-center">
          ...
          <div className="basis-1/2">
            <div onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)} className="hover:cursor-pointer">
              <a>Categories</a>
              {open && (
                <div className="absolute -translate-x-[70px] top-[84px] border-solid border-[3px]
                 border-orange-950 text-black shadow-2xl animate-fadeIn">
                  <div className="absolute h-12 -top-10 left-0 right-0"></div>
        ...
        <div className="basis-7/12 flex justify-center">
          <form className="flex items-center w-full border-2 border-solid border-white rounded-2xl">
            <input
              ...
              placeholder="Search"
            />
            <button type="submit" className="p-2 text-white rounded-r-2xl">S</button>
          </form>
        </div>
        <div className="basis-3/12 flex items-center justify-center space-x-4">
          <div className="px-4 ">
            <button className="relative after:content-[''] after:bg-white after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[5px]
             after:rounded-xl after:absolute after:duration-300 hover:after:w-[100%]"> Sign Up</button>
          </div>
             <div>
